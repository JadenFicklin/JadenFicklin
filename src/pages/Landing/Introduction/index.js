    ...
    return (
        <>
            <div className="relative w-full h-screen">
                ...
                <div
                    id="text-section"
                    className="w-full absolute bottom-0 xl:h-[60%]  flex flex-wrap content-start px-8  mx-auto md:ml-[15%] md:w-[70%] xl:w-[66%] xl:left-1/2 xl:-ml-[33%] xl:content-end xl:mb-[10%]  h-[60%] md:h-[50%] ">
                    <p
