...
const Project = ({ project }) => (
    <div className="z-20 grid w-full grid-cols-1 h-min md:grid-cols-2 md:mx-auto">
        ...
        <div className="w-9/12 mx-auto mt-10 xl:scale-125 xl:ml-32">
            ...
            <p className=" text-[18px] mt-6 max-w-[300px]">{project.subtext}</p>
            <div className="text-[18px] font-semibold flex flex-wrap mt-6">
                ...
                <button className="flex self-start w-full relative ease-in-out duration-200 hover:text-[#0094FF]">
                    More Info
                    <span>
                        <BsFillArrowUpRightCircleFill className="inline ml-3 -mt-1 duration-200" />
                    </span>
                </button>
            </div>
        </div>
