    ...
    <div className="grid w-9/12 grid-cols-1 mx-auto lg:grid-cols-2 lg:mt-24 xl:w-8/12 xl:relative xl:-left-[5%]">
      ...
      <div className="w-full">
        ...
        <p className="mt-7 md:text-[16px]">
          I'm passionate about crafting websites using modular, clean, and
          reusable code. <br></br>
          <br></br> I find that I am constantly coding in my free time. This
          propels me towards continuous learning and self-improvement. I have 3
          older brothers who are also website developers, their encouragement
          inspires me to push the boundaries of programming. <br></br>
          <br></br>
          Above all, I firmly believe in the power of collaboration and learning
          from fellow developers. Embracing guidance and exchanging ideas with
          others will lead to mutual growth and ultimately, better results.
        </p>
        {/* links */}
